...
import EmpvisitorDetailsTableRow from './Emp_visitorDetailsTableRow';
// import AddVisitor from './addVisitor';
import AddVisitor from '../manageVisitor/addVisitor';

export default function EmpvisitorDetailsTable({ title, tableLabels, Categories_Data, subheader }) {
...
EmpvisitorDetailsTable.propTypes = {
