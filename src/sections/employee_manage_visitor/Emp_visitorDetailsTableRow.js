...
import EditVisitors from '../manageVisitor/editVisitor';
// import { ConfirmDialog } from 'src/components/custom-dialog';

function EmpvisitorDetailsTableRow  ({
  row,
  selected,
  onSelectRow,
  onViewRow,
...
EmpvisitorDetailsTableRow.propTypes = {
...
export default EmpvisitorDetailsTableRow;
