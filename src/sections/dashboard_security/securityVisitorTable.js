...
import SecurityVisitorTableRow from './securityVisitorTableRow';


export default function SecurityVisitorTable({ title, tableLabels, Categories_Data, subheader }) {
...
SecurityVisitorTable.propTypes = {
