...
import EmployeeVisitorTableRow from './employeeVisitorTableRow';

export default function EmployeeVisitorTable({ title, tableLabels, Categories_Data, subheader }) {
...
EmployeeVisitorTable.propTypes = {
