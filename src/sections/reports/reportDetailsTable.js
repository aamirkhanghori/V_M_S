...
import ReportDetailsTableRow from './reportDetailsTableRow';



export default function ReportDetailsTable({ title, tableLabels, Categories_Data, subheader }) {
